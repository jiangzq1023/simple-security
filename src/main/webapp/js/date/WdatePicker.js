/*添加更改:即发此日期控件*/
$('.hp-date').focus(function(e){WdatePicker();$(this).attr("readOnly",true)});$('.hp-date').ready(function(e){$(this).attr("readOnly",true);});$('.hp-date').click(function(e){WdatePicker();$(this).attr("readOnly",true)});
$('.hp-date-hhmm').focus(function(e){WdatePicker({starDate:'%y-%M-01 00:00',dateFmt:'yyyy-MM-dd HH:mm',alwaysUseStartDate:true});$(this).attr("readOnly",true)});$('.hp-date-hhmm').ready(function(e){$(this).attr("readOnly",true);});$('.hp-date-hhmm').click(function(e){WdatePicker({starDate:'%y-%M-01 00:00',dateFmt:'yyyy-MM-dd HH:mm',alwaysUseStartDate:true});$(this).attr("readOnly",true)});
$('.hp-date-hhmmss').focus(function(e){WdatePicker({starDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true});$(this).attr("readOnly",true)});$('.hp-date-hhmmss').ready(function(e){$(this).attr("readOnly",true);});$('.hp-date-hhmmss').click(function(e){WdatePicker({starDate:'%y-%M-01 00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true});$(this).attr("readOnly",true)});
$('.hp-date-yyyymm').focus(function(e){WdatePicker({starDate:'%y-%M',dateFmt:'yyyy-MM'});$(this).attr("readOnly",true)});$('.hp-date-yyyymm').ready(function(e){$(this).attr("readOnly",true);});$('.hp-date-yyyymm').click(function(e){WdatePicker({starDate:'%y-%M',dateFmt:'yyyy-MM'});$(this).attr("readOnly",true)});
$('.hp-date-start').focus(function(e){WdatePicker();$(this).attr("readOnly",true)});$('.hp-date-start').ready(function(e){$(this).attr("readOnly",true);});$('.hp-date-start').click(function(e){WdatePicker();$(this).attr("readOnly",true)});
$('.hp-date-end').focus(function(e){WdatePicker();$(this).attr("readOnly",true)});$('.hp-date-end').ready(function(e){$(this).attr("readOnly",true);});$('.hp-date-end').click(function(e){WdatePicker();$(this).attr("readOnly",true)});
